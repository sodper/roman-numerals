...
Roman numerals TDD kata. Implemented using the node [project scaffolding template for GruntJS](http://gruntjs.com/project-scaffolding), which includes test setup with [nodeunit](https://github.com/caolan/nodeunit).
